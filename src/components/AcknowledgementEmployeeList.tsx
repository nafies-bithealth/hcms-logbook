...
interface AcknowledgementEmployeeListProps {
  onBack: () => void;
  onSelectEmployee: (employee: Employee) => void;
  openSidebar: () => void;
}

export function AcknowledgementEmployeeList({ onBack, onSelectEmployee, openSidebar }: AcknowledgementEmployeeListProps) {
  const [searchQuery, setSearchQuery] = useState("");
  const [positionFilter, setPositionFilter] = useState("");
  const [statusFilter, setStatusFilter] = useState("");
  const [viewMode, setViewMode] = useState<"card" | "table">("card");

  // Mock data - employees who have pending logbooks for acknowledgement
  const employees: Employee[] = [
    { id: "1", name: "Geraldi Jonathan", employeeId: "24001254", department: "General Ward Nursing", departmentCode: "SHKJ", pendingCount: 3, position: "Staff Nurse" },
    { id: "2", name: "Mason Olivia", employeeId: "24001255", department: "Pediatric Care", departmentCode: "PLMK", pendingCount: 2, position: "Clinical Nurse" },
    { id: "3", name: "Nguyen Ethan", employeeId: "24001256", department: "Cardiac Rehabilitation", departmentCode: "QWXE", pendingCount: 5, position: "Staff Nurse" },
    { id: "4", name: "Smith Ava", employeeId: "24001257", department: "Emergency Services", departmentCode: "YUIO", pendingCount: 1, position: "Senior Nurse" },
    { id: "5", name: "Patel Aiden", employeeId: "24001258", department: "Surgical Unit", departmentCode: "ASDF", pendingCount: 4, position: "Clinical Nurse" },
    { id: "6", name: "Johnson Mia", employeeId: "24001259", department: "Maternity Care", departmentCode: "RTYU", pendingCount: 2, position: "Staff Nurse" },
    { id: "7", name: "Lee Noah", employeeId: "24001260", department: "Intensive Care Unit", departmentCode: "FGHJ", pendingCount: 6, position: "Senior Nurse" },
  ];
      ...
      <div className="bg-white border-b border-[#e4e7ec] px-[16px] py-[12px] flex items-center gap-[12px] shrink-0">
        ...
        <div className="flex-1">
          <p className="font-['Inter:Semi_Bold',sans-serif] text-[#1d2939] text-[18px]">
            Acknowledge Employee Logbook
          </p>
          <p className="font-['Inter:Regular',sans-serif] text-[#475467] text-[13px]">
            Review and acknowledge employee logbook submissions
          </p>
        </div>
      </div>
